<x-guest-layout>
    ...
    <div class="card bg-light">
        ...
        <form method="POST" class="card-body" action="{{ route('login') }}">
            ...
            <!-- Email Address -->
            <div class="d-flex">
                <x-input-label for="email" :value="__('Email')" style="margin-right: 20px"/>
            ...
            <div class="mt-4 d-flex">
                <x-input-label for="password" :value="__('Password')" style="margin-right: 20px"/>

                <x-text-input id="password" class="block xw-100"
                                type="password"
                                name="password"
